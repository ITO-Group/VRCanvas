...
Java_com_example_zhoujianyu_vrcanvas_MainActivity_readDiffStart(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_zhoujianyu_vrcanvas_MainActivity_readDiffStop(JNIEnv *env, jobject instance) {
